...
public class QuestionService {
  ...
  public QuestionService(QuestionRepository questionRepository, TagRepository tagRepository,
      OwnerRepository ownerRepository, AnswerRepository answerRepository,
      CommentRepository commentRepository, APIRepository apiRepository) {
  ...
  public void addQuestions() throws IOException {
    for (int q = 1; q < 11; q++) {
      String filePath =
          "C:\\Users\\cheny\\IdeaProjects\\2023-Spring-Java2-Project-Demo-master\\src\\main\\java\\data\\questions\\"
              + "question_" + q + ".json";
...
//                String body = item.getString("body");
        ...
        questionRepository.save(
            new Question(tags, owner, answer_count, view_count, up_vote_count, creation_date,
                question_id, apis, answers, comments));
      }
    }
  }
